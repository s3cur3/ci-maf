...
{
    wp_enqueue_style('roots_main', get_template_directory_uri() . '/assets/css/main.min.css', false, 'aa24ba3c3b41b4526df12042120f5df0');
    ...
    */
    ...
    wp_register_script('roots_scripts', get_template_directory_uri() . '/assets/js/scripts.min.js', array(), 'b4585123e9e40c12de5d08b3a3a70943', true);
