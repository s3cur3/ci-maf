...
function ciCustomizeRegister($wp_customize)
{
    ...
    $pageSetupOptions = array(
        /*array(
            ...
            'label' => __('Theme Style', 'the-modern-accounting-firm'),
            'options' => array(
                CI_STYLE_CLEAN => __("Clean Lines", 'the-modern-accounting-firm'),
                CI_STYLE_ROUNDED => __("Rounded Corners", 'the-modern-accounting-firm')
            )
        ),*/
        ...
        array(
            ...
            'type' => 'image',
            'label' => __('Full-Screen Background Image', 'the-modern-accounting-firm')
        ),
        array(
            'label' => __("Body Background Pattern", 'the-modern-accounting-firm'),
            'description' => __("To use a subtle pattern (from subtlepatterns.com) as the background to the pages (instead of a flat, solid color or an image), select a pattern here.", 'the-modern-accounting-firm'),
            'slug' => "pattern_bg",
            'default' => "none",
            'type' => "radio-images",
    ...
    $headerOption = array(
        array(
            'slug' => 'social_in_nav',
            'default' => false,
            'label' => __('Show social media icons to the right of the nav bar?', 'the-modern-accounting-firm'),
            'type' => 'checkbox'
        ),
        array(
            'label' => __('Additional "menu" text', 'the-modern-accounting-firm'),
            'description' => __('This will appear to the far right of the navigation menu. Example: Call us at (123) 456-7890', 'the-modern-accounting-firm'),
        ...
        array(
            'slug' => 'navbar_fixed',
            'default' => false,
            'label' => __('Fix navigation bar to top of screen?', 'the-modern-accounting-firm'),
            'type' => 'checkbox'
        ),
        array(
            'slug' => 'header_link_size',
            'default' => '100',
            'label' => __('Nav Menu Text Size (percent)', 'the-modern-accounting-firm'),
            'type' => 'text'
        ),
        array(
            'slug' => 'company_logo',
            'label' => __('Company Logo', 'the-modern-accounting-firm'),
            'type' => 'image'
        ),
        array(
            'slug' => 'svg_logo',
            'label' => __('Company Logo (SVG Version, used only on supported browsers)', 'the-modern-accounting-firm'),
            'type' => 'image'
        ),
        array(
            'slug' => 'logo_width',
            'default' => '',
            'label' => __('Width to display logo (px)', 'the-modern-accounting-firm'),
            'type' => 'text'
        ),
        array(
            'slug' => 'logo_height',
            'default' => '',
            'label' => __('Height to display logo (px)', 'the-modern-accounting-firm'),
            'type' => 'text'
        ),
        array(
            'slug' => 'logo_top_padding',
            'default' => '24',
            'label' => __('Top padding for logo (px)', 'the-modern-accounting-firm'),
            'type' => 'text'
        )
    );
    $wp_customize->add_section('header', array('title' => __('Header', 'the-modern-accounting-firm'), 'description' => __('Configure your logo, the navigation menu, and other items in the site-wide header.', 'the-modern-accounting-firm'), 'priority' => 0,));
    ...
    $colors = array(
        ...
        array(
            ...
            'label' => __('Body Colors', 'the-modern-accounting-firm')
        ),
        array(
            'slug' => 'splash_color',
            'default' => $defaultColors['splash_color'],
            'type' => 'color',
            'label' => __('Link Color', 'the-modern-accounting-firm')
        ),
        array(
            'slug' => 'button_color',
            'default' => $defaultColors['button_color'],
            'type' => 'color',
            'label' => __('Button Color', 'the-modern-accounting-firm')
        ),
        array(
            'slug' => 'page_title_color',
            'default' => $defaultColors['page_title_color'],
            'type' => 'color',
            'label' => __('Page Title Color', 'the-modern-accounting-firm')
        ),
        array(
            'slug' => 'heading_color',
            'default' => $defaultColors['heading_color'],
            'type' => 'color',
            'label' => __('Level 2 Heading Color', 'the-modern-accounting-firm')
        ),
        array(
            'slug' => 'background_color',
            'default' => $defaultColors['background_color'],
            'type' => 'color',
            'label' => __('Background Color', 'the-modern-accounting-firm')
        ),
        array(
            'slug' => 'secondary_background_color',
            'default' => $defaultColors['secondary_background_color'],
            'type' => 'color',
            'label' => __('Secondary Background Color', 'the-modern-accounting-firm')
        ),
        array(
            'slug' => 'copyright_text_color',
            'default' => '#333333',
            'label' => __('Footer copyright notice text color', 'the-modern-accounting-firm'),
            'type' => 'color'
        ),
        ...
        array(
            ...
            'label' => __('Header Colors', 'the-modern-accounting-firm')
        ),
        array(
            'slug' => 'firm_name_color',
            'default' => $defaultColors['firm_name_color'],
            'label' => __('Company Name Color', 'the-modern-accounting-firm'),
            'type' => 'color'
        ),
        array(
            'slug' => 'header_text_color',
            'default' => $defaultColors['header_text_color'],
            'label' => __('Nav Menu Text Color', 'the-modern-accounting-firm'),
            'type' => 'color'
        ),
        array(
            'slug' => 'header_highlight_color',
            'default' => $defaultColors['header_highlight_color'],
            'label' => __('Nav Menu Highlight ("You Are Here") Color', 'the-modern-accounting-firm'),
            'type' => 'color'
        ),
        array(
            'slug' => 'header_hover_color',
            'default' => $defaultColors['header_hover_color'],
            'label' => __('Nav Menu Hover Color', 'the-modern-accounting-firm'),
            'type' => 'color'
        ),
        array(
            'slug' => 'header_bg_color',
            'default' => $defaultColors['header_bg_color'],
            'label' => __('Nav Menu Background Color', 'the-modern-accounting-firm'),
            'type' => 'color'
        ),
        array(
            ...
            'default' => true,
            'label' => __('Active Menu Item Has Solid Background?', 'the-modern-accounting-firm'),
            'type' => 'checkbox'
        ),
        array(
            'type' => 'line',
        ...
        array(
            ...
            'label' => __('Fancy Landing Page Colors', 'the-modern-accounting-firm')
        ),
        array(
            'slug' => 'fancy_landing_text_color',
            'default' => "#ffffff",
            'type' => 'color',
            'label' => __('Text Color', 'the-modern-accounting-firm')
        ),
        array(
            'slug' => 'fancy_landing_splash_color',
            'default' => $defaultColors['splash_color'],
            'type' => 'color',
            'label' => __('Highlight Color', 'the-modern-accounting-firm')
        ),
        array(
        ...
        array(
            ...
            'default' => "#ffffff",
            'type' => 'color',
            'label' => __('Other Headings Color', 'the-modern-accounting-firm')
        )
    );
    ...
    $footerOptions = array(
        array(
            'slug' => 'footer_columns',
            'default' => '4',
            'label' => __('Footer Columns (1-4)', 'the-modern-accounting-firm'),
            'description' => __('We place each widget in the Footer widget area in its own column; in general, you want this number to match the number of widgets you place in the Footer widget area.', 'the-modern-accounting-firm'),
            'type' => 'text'
        ),
        array(
            'label' => __('Footer text (for the bottom of each page)', 'the-modern-accounting-firm'),
            'description' => "If you'd like text at the very, very bottom of each page, you can type it here.",
            'slug' => 'disclaimer',
            'type' => 'textarea'
        ),
        array(
            'label' => __('Copyright Text', 'the-modern-accounting-firm'),
            'description' => __('Appears beneath the footer text, if applicable', 'the-modern-accounting-firm'),
            'slug' => 'copyright',
            'default' => '&copy; ' . date('Y') . ' ' . do_shortcode(get_bloginfo('name')),
            'type' => 'text'
        ),
        array(
            'label' => __('Enable theme design attribution?', 'the-modern-accounting-firm'),
            'description' => __('If checked, enables a brief credit line for the theme\'s creators', 'the-modern-accounting-firm'),
            'slug' => 'enable_attribution',
            'default' => 1,
            'type' => 'checkbox'
        )
    );
    $wp_customize->add_section('footer', array('title' => __('Footer', 'the-modern-accounting-firm'), 'priority' => 100));
    ...
    $wp_customize->add_section('social_media', array('title' => __('Social Media Links', 'the-modern-accounting-firm'), 'priority' => 100,));
    ...
    $faviconOptions = array(
        array(
            'slug' => 'favicon',
            'label' => __('Favicon for site', 'the-modern-accounting-firm'),
            'description' => __('A <a href="http://en.wikipedia.org/wiki/Favicon" target="_blank">favicon</a> is the little icon displayed in the page\'s tab. You can create one from a 16&times;16 image using the <a href="http://www.favicon.cc/" target="_blank">Favicon Generator</a>.', 'the-modern-accounting-firm'),
            'type' => 'image'
        ),
        array(
            'label' => __('Apple Touch Icon', 'the-modern-accounting-firm'),
            'description' => __('When someone adds your site to their home screen on an Apple device (iPhone, iPad, etc.), the <a href="https://developer.apple.com/library/ios/documentation/AppleApplications/Reference/SafariWebContent/ConfiguringWebApplications/ConfiguringWebApplications.html" target="_blank">Apple Touch Icon</a> is the image that will be used. (Typically, a 152&times;152 PNG is recommended.)', 'the-modern-accounting-firm'),
            'slug' => 'touch_icon',
            'type' => 'image'
        ),
        array(
            ...
            'default' => false,
            'label' => __('Disable added effects on Apple Touch Icon?', 'the-modern-accounting-firm'),
            'description' => __('Disables the curved border, drop shadow, etc. for Apple touch icon', 'the-modern-accounting-firm'),
            'type' => 'checkbox'
        ),
    );
    $wp_customize->add_section('favicon', array('title' => __('Favicon', 'the-modern-accounting-firm')));
    ...
    $cssOptions = array(
        array(
            'slug' => 'custom_css',
            'default' => '',
            'label' => __('Custom CSS', 'the-modern-accounting-firm'),
            'description' => __('If you <em>really</em> don\'t want to create a child theme, you can add custom CSS to the header here.', 'the-modern-accounting-firm'),
            'type' => 'textarea'
        )
    );
    $wp_customize->add_section('custom_css', array('title' => __('Custom CSS', 'the-modern-accounting-firm')));
    ...
    $analyticsOptions = array(
        array(
            'slug' => 'analytics_id',
            'default' => '',
            'label' => __('Google Analytics ID', 'the-modern-accounting-firm'),
            'description' => __('Format: <code>UA-XXXXX-Y</code> (Note: Universal Analytics only, not Classic Analytics). Note that Analytics tracking will <em>not</em> be active when you are logged in. (Open a different Web browser to test it.)', 'the-modern-accounting-firm'),
            'type' => 'text'
        )
    );
    $wp_customize->add_section('analytics', array('title' => __('Google Analytics', 'the-modern-accounting-firm')));
